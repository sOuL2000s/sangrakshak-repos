...
import { Eye, EyeOff, Shield, Chrome, Lock, Mail, User, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      toast({
        ...
        description: "Welcome to Sangrakshak! Your account has been created successfully."
      });
      navigate('/');
    } else {
      toast({
      ...
      <Card className="w-full max-w-md bg-black/40 border-cyan-500/20 backdrop-blur-lg relative z-10">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-gray-300">
            Join Sangrakshak to protect your digital assets
          </CardDescription>
        </CardHeader>
